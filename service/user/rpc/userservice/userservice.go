...
type (
	...
	DeleteUserReq  = __.DeleteUserReq
	DeleteUserResp = __.DeleteUserResp
	GetUserReq     = __.GetUserReq
	GetUserResp    = __.GetUserResp
	LoginReq       = __.LoginReq
	LoginResp      = __.LoginResp
	LogoutReq      = __.LogoutReq
	LogoutResp     = __.LogoutResp
	UpdateUserReq  = __.UpdateUserReq
	UpdateUserResp = __.UpdateUserResp
