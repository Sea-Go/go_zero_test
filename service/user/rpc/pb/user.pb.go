...
type UserInfo struct {
	...
	ExtraInfo     map[string]string      `protobuf:"bytes,4,rep,name=extra_info,json=extraInfo,proto3" json:"extra_info,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` //这里对应我们在数据库的json字段
...
const file_pb_user_proto_rawDesc = "" +
	"\n" +
	"\rpb/user.proto\x12\x04user\"\xc8\x01\n" +
	"\bUserInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x04R\x02id\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12<\n" +
	"\n" +
	"extra_info\x18\x04 \x03(\v2\x1d.user.UserInfo.ExtraInfoEntryR\textraInfo\x1a<\n" +
	...
	"\asuccess\x18\x01 \x01(\bR\asuccess2\xbf\x02\n" +
	"\vUserService\x12.\n" +
	...
	"\n" +
	"DeleteUser\x12\x13.user.DeleteUserReq\x1a\x14.user.DeleteUserRespB\x03Z\x01.b\x06proto3"
...
var file_pb_user_proto_depIdxs = []int32{
	...
	4,  // 12: user.UserService.CreateUser:output_type -> user.CreateUserResp
